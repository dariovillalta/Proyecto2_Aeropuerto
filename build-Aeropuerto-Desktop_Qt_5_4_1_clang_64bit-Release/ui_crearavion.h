...
public:
    ...
    void setupUi(QDialog *CrearAvion)
    {
        ...
        tf_marca = new QLineEdit(CrearAvion);
        ...
        label_9 = new QLabel(CrearAvion);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setFont(font);

        gridLayout->addWidget(label_9, 3, 2, 1, 1);

        tf_modelo = new QLineEdit(CrearAvion);
        tf_modelo->setObjectName(QStringLiteral("tf_modelo"));

        gridLayout->addWidget(tf_modelo, 3, 3, 1, 1);
    ...
    void retranslateUi(QDialog *CrearAvion)
    {
        ...
        label_8->setText(QApplication::translate("CrearAvion", "Marca", 0));
        label_4->setText(QApplication::translate("CrearAvion", "Longitud", 0));
        label_9->setText(QApplication::translate("CrearAvion", "Modelo", 0));
